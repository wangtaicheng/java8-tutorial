...
public class CompletableFuture2 {
    ...
    private static long testStream(int jobCount) {
        ...
        IntStream.rangeClosed(1, jobCount).forEach(value -> tasks.add(CompletableFuture2::getJob));
    ...
    private static long testCompletableFutureDefaultExecutor(int jobCount) {
        ...
        IntStream.rangeClosed(1, jobCount).forEach(value -> tasks.add(CompletableFuture.supplyAsync(CompletableFuture2::getJob)));
    ...
    private static long testCompletableFutureCustomExecutor(int jobCount) {
        ...
        List<CompletableFuture<Integer>> tasks = new ArrayList<>();
        IntStream.rangeClosed(1, jobCount).forEach(value -> tasks.add(CompletableFuture.supplyAsync(CompletableFuture2::getJob, executor)));
